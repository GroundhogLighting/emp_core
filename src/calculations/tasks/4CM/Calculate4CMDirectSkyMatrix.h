...
public:
     ...
     */
    Calculate4CMDirectSkyMatrix(GroundhogModel * theModel, Workplane * wp, int theMF)
    {
    ...
    /*!
     @author German Molina
     */
    Calculate4CMDirectSkyMatrix(GroundhogModel * theModel, std::vector<RAY> * theRays, int theMF)
    {
